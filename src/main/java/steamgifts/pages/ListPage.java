...
public class ListPage extends BaseForm {
    ...
    private final ElementsCollection sePinnedGames = $$(".pinned-giveaways div:not(.is-faded) > a.giveaway_image_thumbnail, div:not(.is-faded) > a.giveaway_image_thumbnail_missing");
